...
using hls::sim::Byte;
extern "C" void swiglu(Byte<4>*, volatile void *, volatile void *, volatile void *, volatile void *, int, int, float);
...
__xlx_out_batch__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_out_batch)[i]);
  ...
  // DUT call
  swiglu(__xlx_out_batch__tmp_vec.data(), __xlx_apatb_param_W, __xlx_apatb_param_V, __xlx_apatb_param_W_down, __xlx_apatb_param_x_batch, __xlx_offset_byte_param_out_batch, __xlx_apatb_param_down_quant_mode, __xlx_apatb_param_x_scale);
