...
HLS_SOURCES = ../../../../swiglu_tb.cpp ../../../../swiglu.cpp
...
$(ObjDir)/swiglu_tb.o: ../../../../swiglu_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../swiglu_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/swiglu_tb.d

$(ObjDir)/swiglu.o: ../../../../swiglu.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../swiglu.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/swiglu.d
