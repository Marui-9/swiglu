...
entry:
  ...
  %6 = bitcast i8* %x_batch to [2048 x i8]*
  %x_batch_copy = alloca [2048 x i8], align 512
  %7 = getelementptr inbounds [2048 x i8], [2048 x i8]* %x_batch_copy, i64 0, i64 0
  %8 = bitcast float* %out_batch to [2048 x float]*
  %9 = call i8* @malloc(i64 8192)
  %out_batch_copy = bitcast i8* %9 to [2048 x float]*
  call fastcc void @copy_in([9437184 x i8]* nonnull %0, [9437184 x i8]* %W_copy, [9437184 x i8]* nonnull %2, [9437184 x i8]* %V_copy, [13762560 x i8]* nonnull %4, [13762560 x i8]* %W_down_copy, [2048 x i8]* nonnull %6, [2048 x i8]* nonnull align 512 %x_batch_copy, [2048 x float]* nonnull %8, [2048 x float]* %out_batch_copy)
  call void @apatb_swiglu_hw([9437184 x i8]* %W_copy, [9437184 x i8]* %V_copy, [13762560 x i8]* %W_down_copy, i8* %7, [2048 x float]* %out_batch_copy, i32 %down_quant_mode, float %x_scale)
  call void @copy_back([9437184 x i8]* %0, [9437184 x i8]* %W_copy, [9437184 x i8]* %2, [9437184 x i8]* %V_copy, [13762560 x i8]* %4, [13762560 x i8]* %W_down_copy, [2048 x i8]* %6, [2048 x i8]* %x_batch_copy, [2048 x float]* %8, [2048 x float]* %out_batch_copy)
...
define internal fastcc void @copy_in([9437184 x i8]* readonly, [9437184 x i8]*, [9437184 x i8]* readonly, [9437184 x i8]*, [13762560 x i8]* readonly, [13762560 x i8]*, [2048 x i8]* readonly, [2048 x i8]* align 512, [2048 x float]* readonly, [2048 x float]*) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2048i8([2048 x i8]* align 512 %7, [2048 x i8]* %6)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a2048i8([2048 x i8]* align 512 %dst, [2048 x i8]* readonly %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2048i8([2048 x i8]* %dst, [2048 x i8]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([9437184 x i8]*, [9437184 x i8]* readonly, [9437184 x i8]*, [9437184 x i8]* readonly, [13762560 x i8]*, [13762560 x i8]* readonly, [2048 x i8]*, [2048 x i8]* readonly align 512, [2048 x float]*, [2048 x float]* readonly) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2048i8([2048 x i8]* %6, [2048 x i8]* align 512 %7)
...
declare void @apatb_swiglu_hw([9437184 x i8]*, [9437184 x i8]*, [13762560 x i8]*, i8*, [2048 x float]*, i32, float)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([9437184 x i8]*, [9437184 x i8]* readonly, [9437184 x i8]*, [9437184 x i8]* readonly, [13762560 x i8]*, [13762560 x i8]* readonly, [2048 x i8]*, [2048 x i8]* readonly align 512, [2048 x float]*, [2048 x float]* readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a2048f32([2048 x float]* %8, [2048 x float]* %9)
  ret void
}
...
define void @swiglu_hw_stub_wrapper([9437184 x i8]*, [9437184 x i8]*, [13762560 x i8]*, i8*, [2048 x float]*, i32, float) #5 {
entry:
  %7 = bitcast i8* %3 to [2048 x i8]*
  call void @copy_out([9437184 x i8]* null, [9437184 x i8]* %0, [9437184 x i8]* null, [9437184 x i8]* %1, [13762560 x i8]* null, [13762560 x i8]* %2, [2048 x i8]* null, [2048 x i8]* %7, [2048 x float]* null, [2048 x float]* %4)
  %8 = bitcast [9437184 x i8]* %0 to i8*
  %9 = bitcast [9437184 x i8]* %1 to i8*
  %10 = bitcast [13762560 x i8]* %2 to i8*
  %11 = bitcast [2048 x i8]* %7 to i8*
  %12 = bitcast [2048 x float]* %4 to float*
  call void @swiglu_hw_stub(i8* %8, i8* %9, i8* %10, i8* %11, float* %12, i32 %5, float %6)
  call void @copy_in([9437184 x i8]* null, [9437184 x i8]* %0, [9437184 x i8]* null, [9437184 x i8]* %1, [13762560 x i8]* null, [13762560 x i8]* %2, [2048 x i8]* null, [2048 x i8]* %7, [2048 x float]* null, [2048 x float]* %4)
  ret void
}
