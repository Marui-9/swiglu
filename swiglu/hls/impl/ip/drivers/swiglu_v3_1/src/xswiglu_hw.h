...
#define XSWIGLU_CTRL_BITS_W_DATA               8
#define XSWIGLU_CTRL_ADDR_V_DATA               0x18
#define XSWIGLU_CTRL_BITS_V_DATA               8
#define XSWIGLU_CTRL_ADDR_W_DOWN_DATA          0x20
#define XSWIGLU_CTRL_BITS_W_DOWN_DATA          8
#define XSWIGLU_CTRL_ADDR_X_BATCH_DATA         0x28
#define XSWIGLU_CTRL_BITS_X_BATCH_DATA         8
#define XSWIGLU_CTRL_ADDR_OUT_BATCH_DATA       0x30
#define XSWIGLU_CTRL_BITS_OUT_BATCH_DATA       64
#define XSWIGLU_CTRL_ADDR_DOWN_QUANT_MODE_DATA 0x3c
#define XSWIGLU_CTRL_BITS_DOWN_QUANT_MODE_DATA 32
#define XSWIGLU_CTRL_ADDR_X_SCALE_DATA         0x44
