set moduleName load_row_wv_Pipeline_LOAD_WV_VITIS_LOOP_100_1
set isTopModule 0
...
set cdfgNum 36
set C_modelName {load_row_wv_Pipeline_LOAD_WV_VITIS_LOOP_100_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_V", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "V","offset": { "type": "dynamic","port_name": "V","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln99", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln99 sc_in sc_lv 60 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln99", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln99", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln99 { ap_none {  { sext_ln99 in_data 0 60 } } }
