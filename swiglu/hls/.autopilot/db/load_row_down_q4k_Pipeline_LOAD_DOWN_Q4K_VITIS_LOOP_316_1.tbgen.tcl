set moduleName load_row_down_q4k_Pipeline_LOAD_DOWN_Q4K_VITIS_LOOP_316_1
set isTopModule 0
...
set cdfgNum 36
set C_modelName {load_row_down_q4k_Pipeline_LOAD_DOWN_Q4K_VITIS_LOOP_316_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict rb_0 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_1 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_2 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_3 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_4 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_5 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_6 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict rb_7 { MEM_WIDTH 128 MEM_SIZE 576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_Wd int 128 regular {axi_master 0}  }
	{ sext_ln315 int 60 regular  }
	{ rb_0 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_1 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_2 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_3 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_4 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_5 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_6 int 128 regular {array 36 { 0 3 } 0 1 }  }
	{ rb_7 int 128 regular {array 36 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_Wd", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "W_down","offset": { "type": "dynamic","port_name": "W_down","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln315", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln315 sc_in sc_lv 60 signal 1 } 
	{ rb_0_address0 sc_out sc_lv 6 signal 2 } 
	{ rb_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ rb_0_we0 sc_out sc_logic 1 signal 2 } 
	{ rb_0_d0 sc_out sc_lv 128 signal 2 } 
	{ rb_1_address0 sc_out sc_lv 6 signal 3 } 
	{ rb_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ rb_1_we0 sc_out sc_logic 1 signal 3 } 
	{ rb_1_d0 sc_out sc_lv 128 signal 3 } 
	{ rb_2_address0 sc_out sc_lv 6 signal 4 } 
	{ rb_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ rb_2_we0 sc_out sc_logic 1 signal 4 } 
	{ rb_2_d0 sc_out sc_lv 128 signal 4 } 
	{ rb_3_address0 sc_out sc_lv 6 signal 5 } 
	{ rb_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ rb_3_we0 sc_out sc_logic 1 signal 5 } 
	{ rb_3_d0 sc_out sc_lv 128 signal 5 } 
	{ rb_4_address0 sc_out sc_lv 6 signal 6 } 
	{ rb_4_ce0 sc_out sc_logic 1 signal 6 } 
	{ rb_4_we0 sc_out sc_logic 1 signal 6 } 
	{ rb_4_d0 sc_out sc_lv 128 signal 6 } 
	{ rb_5_address0 sc_out sc_lv 6 signal 7 } 
	{ rb_5_ce0 sc_out sc_logic 1 signal 7 } 
	{ rb_5_we0 sc_out sc_logic 1 signal 7 } 
	{ rb_5_d0 sc_out sc_lv 128 signal 7 } 
	{ rb_6_address0 sc_out sc_lv 6 signal 8 } 
	{ rb_6_ce0 sc_out sc_logic 1 signal 8 } 
	{ rb_6_we0 sc_out sc_logic 1 signal 8 } 
	{ rb_6_d0 sc_out sc_lv 128 signal 8 } 
	{ rb_7_address0 sc_out sc_lv 6 signal 9 } 
	{ rb_7_ce0 sc_out sc_logic 1 signal 9 } 
	{ rb_7_we0 sc_out sc_logic 1 signal 9 } 
	{ rb_7_d0 sc_out sc_lv 128 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln315", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln315", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln315 { ap_none {  { sext_ln315 in_data 0 60 } } }
	rb_0 { ap_memory {  { rb_0_address0 mem_address 1 6 }  { rb_0_ce0 mem_ce 1 1 }  { rb_0_we0 mem_we 1 1 }  { rb_0_d0 mem_din 1 128 } } }
	rb_1 { ap_memory {  { rb_1_address0 mem_address 1 6 }  { rb_1_ce0 mem_ce 1 1 }  { rb_1_we0 mem_we 1 1 }  { rb_1_d0 mem_din 1 128 } } }
	rb_2 { ap_memory {  { rb_2_address0 mem_address 1 6 }  { rb_2_ce0 mem_ce 1 1 }  { rb_2_we0 mem_we 1 1 }  { rb_2_d0 mem_din 1 128 } } }
	rb_3 { ap_memory {  { rb_3_address0 mem_address 1 6 }  { rb_3_ce0 mem_ce 1 1 }  { rb_3_we0 mem_we 1 1 }  { rb_3_d0 mem_din 1 128 } } }
	rb_4 { ap_memory {  { rb_4_address0 mem_address 1 6 }  { rb_4_ce0 mem_ce 1 1 }  { rb_4_we0 mem_we 1 1 }  { rb_4_d0 mem_din 1 128 } } }
	rb_5 { ap_memory {  { rb_5_address0 mem_address 1 6 }  { rb_5_ce0 mem_ce 1 1 }  { rb_5_we0 mem_we 1 1 }  { rb_5_d0 mem_din 1 128 } } }
	rb_6 { ap_memory {  { rb_6_address0 mem_address 1 6 }  { rb_6_ce0 mem_ce 1 1 }  { rb_6_we0 mem_we 1 1 }  { rb_6_d0 mem_din 1 128 } } }
	rb_7 { ap_memory {  { rb_7_address0 mem_address 1 6 }  { rb_7_ce0 mem_ce 1 1 }  { rb_7_we0 mem_we 1 1 }  { rb_7_d0 mem_din 1 128 } } }
}
