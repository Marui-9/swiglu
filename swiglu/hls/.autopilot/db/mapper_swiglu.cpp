...
__xlx_W__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_W)[i]);
}
  int __xlx_size_param_W = 589824;
  int __xlx_offset_param_W = 0;
  int __xlx_offset_byte_param_W = 0*16;
  // Collect __xlx_V__tmp_vec
std::vector<Byte<16>> __xlx_V__tmp_vec;
for (size_t i = 0; i < 589824; ++i){
__xlx_V__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_V)[i]);
}
  int __xlx_size_param_V = 589824;
  int __xlx_offset_param_V = 0;
  int __xlx_offset_byte_param_V = 0*16;
  // Collect __xlx_W_down__tmp_vec
std::vector<Byte<16>> __xlx_W_down__tmp_vec;
for (size_t i = 0; i < 860160; ++i){
__xlx_W_down__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_W_down)[i]);
}
...
((Byte<16>*)__xlx_apatb_param_V)[i] = __xlx_V__tmp_vec[__xlx_offset_param_V+i];
}
...
((Byte<16>*)__xlx_apatb_param_x_batch)[i] = __xlx_x_batch__tmp_vec[__xlx_offset_param_x_batch+i];
}
// print __xlx_apatb_param_out_batch
for (size_t i = 0; i < __xlx_size_param_out_batch; ++i) {
((Byte<4>*)__xlx_apatb_param_out_batch)[i] = __xlx_out_batch__tmp_vec[__xlx_offset_param_out_batch+i];
}
}
