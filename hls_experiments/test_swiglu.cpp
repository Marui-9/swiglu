...
//IMPORTANT NOTE: THIS IP WAS ABANDONED BECAUSE IT SYNTHESIZED WITH -6.3ns WNS
//NOT DEPLOYABLE
//The inner #pragma HLS DATAFLOW inside a loop forces HLS to synthesize a monolithic 
//FSM for the entire function (no outer DATAFLOW pipelining between phases)
//The tradeoff is irreconcilable with HLS: outer DATAFLOW gives good timing but sequential 
//inner loops; inner DATAFLOW gives overlapped load/MAC but monolithic FSM with no timing closure. 
//The designs represent two opposite ends of that tradeoff.
