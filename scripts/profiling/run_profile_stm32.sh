...
PP_T1=$(grep '±' "$LOG" | grep -v ' tg' | sed -n '1p' | awk '{print $NF}')
TG_T1=$(grep '±' "$LOG" | grep ' tg'   | sed -n '1p' | awk '{print $NF}')
PP_T2=$(grep '±' "$LOG" | grep -v ' tg' | sed -n '2p' | awk '{print $NF}')
TG_T2=$(grep '±' "$LOG" | grep ' tg'   | sed -n '2p' | awk '{print $NF}')
