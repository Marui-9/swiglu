set moduleName load_row_down_q4k_Pipeline_LOAD_DOWN_Q4K_VITIS_LOOP_435_1
set isTopModule 0
...
set cdfgNum 40
set C_modelName {load_row_down_q4k_Pipeline_LOAD_DOWN_Q4K_VITIS_LOOP_435_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_Wd", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "W_down","offset": { "type": "dynamic","port_name": "W_down","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln434", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln434 sc_in sc_lv 60 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln434", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln434", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln434 { ap_none {  { sext_ln434 in_data 0 60 } } }
