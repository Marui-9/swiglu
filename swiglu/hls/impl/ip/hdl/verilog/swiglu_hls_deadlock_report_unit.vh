    ...
    task print_cycle_chan_comp(input [PROC_NUM - 1:0] dl_vec1, input [PROC_NUM - 1:0] dl_vec2);
        ...
        begin
            ...
            case (index1)
                0 : begin // for proc 'swiglu_swiglu.load_x_local_U0'
                    case(index2)
                    1: begin //  for dep proc 'swiglu_swiglu.compute_X1_U0'
...
// blk sig is {{swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready & swiglu_swiglu_inst.load_x_local_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready} input_sync}
                        if ((ap_sync_load_x_local_U0_ap_ready & load_x_local_U0.ap_idle & ~ap_sync_compute_X1_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X1_U0'");
                        end
                    end
                    2: begin //  for dep proc 'swiglu_swiglu.compute_X2_U0'
...
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready & swiglu_swiglu_inst.load_x_local_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready} input_sync}
                        if ((ap_sync_load_x_local_U0_ap_ready & load_x_local_U0.ap_idle & ~ap_sync_compute_X2_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X2_U0'");
                        end
                    end
                    4: begin //  for dep proc 'swiglu_swiglu.compute_output_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready & swiglu_swiglu_inst.load_x_local_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready} input_sync}
                        if ((ap_sync_load_x_local_U0_ap_ready & load_x_local_U0.ap_idle & ~ap_sync_compute_output_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_output_U0'");
                        end
                    end
                    endcase
                end
                1 : begin // for proc 'swiglu_swiglu.compute_X1_U0'
                    case(index2)
                    0: begin //  for dep proc 'swiglu_swiglu.load_x_local_U0'
// for dep channel 'swiglu_swiglu.x_local_1_U' info is :
...
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready & swiglu_swiglu_inst.compute_X1_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X1_U0_ap_ready & compute_X1_U0.ap_idle & ~ap_sync_load_x_local_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.load_x_local_U0'");
                        end
                    end
                    3: begin //  for dep proc 'swiglu_swiglu.compute_gate_U0'
// for dep channel 'swiglu_swiglu.X1_cache_U' info is :
// blk sig is {{~swiglu_swiglu_inst.X1_cache_U.i_full_n & swiglu_swiglu_inst.compute_X1_U0.ap_done & ap_done_reg_1 & ~swiglu_swiglu_inst.X1_cache_U.t_read} data_PIPO}
                        if ((~X1_cache_U.i_full_n & compute_X1_U0.ap_done & ap_done_reg_1 & ~X1_cache_U.t_read)) begin
                            if (~X1_cache_U.t_empty_n) begin
                                $display("//      Blocked by empty input PIPO 'swiglu_swiglu.X1_cache_U' written by process 'swiglu_swiglu.compute_gate_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X1_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~X1_cache_U.i_full_n) begin
                                $display("//      Blocked by full output PIPO 'swiglu_swiglu.X1_cache_U' read by process 'swiglu_swiglu.compute_gate_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X1_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    2: begin //  for dep proc 'swiglu_swiglu.compute_X2_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready & swiglu_swiglu_inst.compute_X1_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X1_U0_ap_ready & compute_X1_U0.ap_idle & ~ap_sync_compute_X2_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X2_U0'");
                        end
                    end
                    4: begin //  for dep proc 'swiglu_swiglu.compute_output_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready & swiglu_swiglu_inst.compute_X1_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X1_U0_ap_ready & compute_X1_U0.ap_idle & ~ap_sync_compute_output_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_output_U0'");
                        end
                    end
                    endcase
                end
                2 : begin // for proc 'swiglu_swiglu.compute_X2_U0'
                    case(index2)
                    0: begin //  for dep proc 'swiglu_swiglu.load_x_local_U0'
// for dep channel 'swiglu_swiglu.x_local_2_U' info is :
...
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready & swiglu_swiglu_inst.compute_X2_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X2_U0_ap_ready & compute_X2_U0.ap_idle & ~ap_sync_load_x_local_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.load_x_local_U0'");
                        end
                    end
                    3: begin //  for dep proc 'swiglu_swiglu.compute_gate_U0'
// for dep channel 'swiglu_swiglu.X2_cache_U' info is :
// blk sig is {{~swiglu_swiglu_inst.X2_cache_U.i_full_n & swiglu_swiglu_inst.compute_X2_U0.ap_done & ap_done_reg_2 & ~swiglu_swiglu_inst.X2_cache_U.t_read} data_PIPO}
                        if ((~X2_cache_U.i_full_n & compute_X2_U0.ap_done & ap_done_reg_2 & ~X2_cache_U.t_read)) begin
                            if (~X2_cache_U.t_empty_n) begin
                                $display("//      Blocked by empty input PIPO 'swiglu_swiglu.X2_cache_U' written by process 'swiglu_swiglu.compute_gate_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X2_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~X2_cache_U.i_full_n) begin
                                $display("//      Blocked by full output PIPO 'swiglu_swiglu.X2_cache_U' read by process 'swiglu_swiglu.compute_gate_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X2_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    1: begin //  for dep proc 'swiglu_swiglu.compute_X1_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready & swiglu_swiglu_inst.compute_X2_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X2_U0_ap_ready & compute_X2_U0.ap_idle & ~ap_sync_compute_X1_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X1_U0'");
                        end
                    end
                    4: begin //  for dep proc 'swiglu_swiglu.compute_output_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready & swiglu_swiglu_inst.compute_X2_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_X2_U0_ap_ready & compute_X2_U0.ap_idle & ~ap_sync_compute_output_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_output_U0'");
                        end
                    end
                    endcase
                end
                3 : begin // for proc 'swiglu_swiglu.compute_gate_U0'
                    case(index2)
                    1: begin //  for dep proc 'swiglu_swiglu.compute_X1_U0'
// for dep channel 'swiglu_swiglu.X1_cache_U' info is :
// blk sig is {{~swiglu_swiglu_inst.X1_cache_U.t_empty_n & swiglu_swiglu_inst.compute_gate_U0.ap_idle & ~swiglu_swiglu_inst.X1_cache_U.i_write} data_PIPO}
                        if ((~X1_cache_U.t_empty_n & compute_gate_U0.ap_idle & ~X1_cache_U.i_write)) begin
                            if (~X1_cache_U.t_empty_n) begin
                                $display("//      Blocked by empty input PIPO 'swiglu_swiglu.X1_cache_U' written by process 'swiglu_swiglu.compute_X1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X1_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~X1_cache_U.i_full_n) begin
                                $display("//      Blocked by full output PIPO 'swiglu_swiglu.X1_cache_U' read by process 'swiglu_swiglu.compute_X1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X1_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    2: begin //  for dep proc 'swiglu_swiglu.compute_X2_U0'
// for dep channel 'swiglu_swiglu.X2_cache_U' info is :
// blk sig is {{~swiglu_swiglu_inst.X2_cache_U.t_empty_n & swiglu_swiglu_inst.compute_gate_U0.ap_idle & ~swiglu_swiglu_inst.X2_cache_U.i_write} data_PIPO}
                        if ((~X2_cache_U.t_empty_n & compute_gate_U0.ap_idle & ~X2_cache_U.i_write)) begin
                            if (~X2_cache_U.t_empty_n) begin
                                $display("//      Blocked by empty input PIPO 'swiglu_swiglu.X2_cache_U' written by process 'swiglu_swiglu.compute_X2_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X2_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~X2_cache_U.i_full_n) begin
                                $display("//      Blocked by full output PIPO 'swiglu_swiglu.X2_cache_U' read by process 'swiglu_swiglu.compute_X2_U0'");
                                $fdisplay(fp, "Dependence_Channel_path swiglu_swiglu.X2_cache_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
...
// blk sig is {{~swiglu_swiglu_inst.gate_cache_7_U.i_full_n & swiglu_swiglu_inst.compute_gate_U0.ap_done & ap_done_reg_3 & ~swiglu_swiglu_inst.gate_cache_7_U.t_read} data_PIPO}
                ...
                4 : begin // for proc 'swiglu_swiglu.compute_output_U0'
                    case(index2)
                    3: begin //  for dep proc 'swiglu_swiglu.compute_gate_U0'
...
// blk sig is {{~swiglu_swiglu_inst.gate_cache_7_U.t_empty_n & swiglu_swiglu_inst.compute_output_U0.ap_idle & ~swiglu_swiglu_inst.gate_cache_7_U.i_write} data_PIPO}
                    ...
                    0: begin //  for dep proc 'swiglu_swiglu.load_x_local_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready & swiglu_swiglu_inst.compute_output_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_load_x_local_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_output_U0_ap_ready & compute_output_U0.ap_idle & ~ap_sync_load_x_local_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.load_x_local_U0'");
                        end
                    end
                    1: begin //  for dep proc 'swiglu_swiglu.compute_X1_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready & swiglu_swiglu_inst.compute_output_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X1_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_output_U0_ap_ready & compute_output_U0.ap_idle & ~ap_sync_compute_X1_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X1_U0'");
                        end
                    end
                    2: begin //  for dep proc 'swiglu_swiglu.compute_X2_U0'
// for dep channel '' info is :
// blk sig is {{swiglu_swiglu_inst.ap_sync_compute_output_U0_ap_ready & swiglu_swiglu_inst.compute_output_U0.ap_idle & ~swiglu_swiglu_inst.ap_sync_compute_X2_U0_ap_ready} input_sync}
                        if ((ap_sync_compute_output_U0_ap_ready & compute_output_U0.ap_idle & ~ap_sync_compute_X2_U0_ap_ready)) begin
                            $display("//      Blocked by input sync logic with process : 'swiglu_swiglu.compute_X2_U0'");
                        end
                    end
                    endcase
