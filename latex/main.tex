...
\hline
T1 & \textbf{TODO} & \textbf{TODO} \\
T2 & \textbf{TODO} & \textbf{TODO} \\
\hline
\end{tabular}
\end{table}
Power was not logged in software; measurements were taken externally using a
Nordic PPK2 inline on the 5\,V supply rail and aligned to benchmark timestamps.
...
The A35 achieves \textbf{TODO}\,t/s decode at T2, versus \textbf{1.07}\,t/s for
the KV260 A53 at T2 (CPU Only) and \textbf{2.03}\,t/s for the KV260 FPGA+CPU path.
This places the KV260 FPGA+CPU configuration at a \textbf{TODO$\times$} decode
speedup over the A35 at matched thread count, at the cost of a more complex
integration and approximately \textbf{TODO}\,W of additional board power.
