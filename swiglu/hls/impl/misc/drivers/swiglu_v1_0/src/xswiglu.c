...
void XSwiglu_Set_W(XSwiglu *InstancePtr, u64 Data) {
    ...
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DATA, (u32)(Data));
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DATA + 4, (u32)(Data >> 32));
}
...
u64 XSwiglu_Get_W(XSwiglu *InstancePtr) {
    ...
    Data += (u64)XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DATA + 4) << 32;
    return Data;
}
...
void XSwiglu_Set_V(XSwiglu *InstancePtr, u64 Data) {
    ...
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_V_DATA, (u32)(Data));
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_V_DATA + 4, (u32)(Data >> 32));
}
...
u64 XSwiglu_Get_V(XSwiglu *InstancePtr) {
    ...
    Data += (u64)XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_V_DATA + 4) << 32;
    return Data;
}
...
void XSwiglu_Set_W_down(XSwiglu *InstancePtr, u64 Data) {
    ...
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN_DATA, (u32)(Data));
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XSwiglu_Get_W_down(XSwiglu *InstancePtr) {
    ...
    Data += (u64)XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN_DATA + 4) << 32;
    return Data;
}

void XSwiglu_Set_W_down2(XSwiglu *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN2_DATA, (u32)(Data));
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN2_DATA + 4, (u32)(Data >> 32));
}

u64 XSwiglu_Get_W_down2(XSwiglu *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN2_DATA);
    Data += (u64)XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_W_DOWN2_DATA + 4) << 32;
    return Data;
}
...
void XSwiglu_Set_x_batch(XSwiglu *InstancePtr, u64 Data) {
    ...
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_X_BATCH_DATA, (u32)(Data));
    XSwiglu_WriteReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_X_BATCH_DATA + 4, (u32)(Data >> 32));
}
...
u64 XSwiglu_Get_x_batch(XSwiglu *InstancePtr) {
    ...
    Data += (u64)XSwiglu_ReadReg(InstancePtr->Ctrl_BaseAddress, XSWIGLU_CTRL_ADDR_X_BATCH_DATA + 4) << 32;
    return Data;
}
